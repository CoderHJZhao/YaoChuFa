...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //修改框架中label的位置,使其居中
        self.flotageLabel = [[UILabel alloc] initWithFrame:(CGRect){(self.bounds.size.width - 64 ) / 2,(self.bounds.size.height-64-44-40) / 2,64,64}];
        ...
        //修改框架中label的字体大小
        self.flotageLabel.font = [UIFont systemFontOfSize:self.flotageLabel.size.height/2 - 5];
